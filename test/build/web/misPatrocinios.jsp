...
<html>
    <head>
        ...
        <title>Recompensas adquiridas</title>
    </head>
    <body>
        ...
        <%        try {
                ...
                java.lang.String idusu = String.valueOf(usuarioActual.getIdusuario());
                // TODO process result here
                java.util.List<west.ws.Patrocinio> result = port.lsPatrocinioWS(idusu, "idusu");
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Listado de recompensas adquiridas</h3>
            </div>
